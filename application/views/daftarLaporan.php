...
<head>
    ...
    <!-- Title Page-->
    <title>SINCAN - Daftar Laporan</title>
                                ...
                                <table class="table table-data2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="tr-shadow">
                                                ...
                                                <td class="desc"><?php echo $r['judul']?></td>
                                                <td><?php echo $r['tanggal']?></td>
                                                <td>
                                                    <span class="status--denied"><?php echo $r['status']?></span>
                                                </td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="<?php echo base_url().'LihatBerita'?>">Lihat Berita</a>
                                                    </div>
                                                </td>
                                        </tr>
                                    <?php } ?>
